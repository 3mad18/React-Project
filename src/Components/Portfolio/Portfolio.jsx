...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center flex-col felx-wrap m-10">
      <div className="container mx-auto flex flex-col items-center px-4">
        <h1 className="text-4xl font-bold uppercase  py-1.5 sm:text-5xl md:text-6xl lg:text-5xl text-[#fff]">Portfolio Component</h1>
        <span className="mx-2 star2 text-lg sm:text-xl md:text-2xl lg:text-3xl text-[white]">★</span>
